...
namespace Pokemon
{
    public partial class frmTroChoi : Form
    {
        ...
        public frmTroChoi()
        {
            ...
            pbResume.Hide();
            wmplayer.URL = path + @"\Resources\musicbg.wav";
        ...
        {
            using (var soundPlayer = new SoundPlayer(Pokemon.Properties.Resources.clickButton))
            {
                soundPlayer.Play();
            }
        ...
        private void CheckMethod()
        {
            ...
            if (linelist.Count > 0)
            {
                ...
                using (var soundPlayer = new SoundPlayer(Pokemon.Properties.Resources.Success))
                {
                    soundPlayer.Play();
                }
                PaintMethod();
        ...
        private void PaintMethod()
        {
            ...
            Thread.Sleep(500);
            //Color bgpanel1 = Color.FromArgb(48, 45, 46);
                ...
                for (int j = 1; j < 16; j++)
                {
                    ...
                    if (Matrix.arr[i, j] != -1)
                    {
                        ...
                        if (isFruitImage)
                        {
                            if (isBigImage)
                            {
                                btnlist[tmp].Image = imageListBig.Images[Matrix.arr[i, j]];
                            }
                            else
                            {
                                btnlist[tmp].Image = imageListSmall.Images[Matrix.arr[i, j]];
                            }
        ...
        private void pictureBoxImage_Click(object sender, EventArgs e)
        {
            ...
            {
                isFruitImage = false;
               // pictureBoxImage.Image = Pokemon.Properties.Resources.fruit;
               // LoadImage();
            }
            else
            {
                isFruitImage = true;
               // pictureBoxImage.Image = Pokemon.Properties.Resources.pokemon;
                //LoadImage();
            }
        }
        ...
        {
            if (panel1.Size == new Size(804, 448))
            {
                
                panel1.Size = new Size(1025, 570);
